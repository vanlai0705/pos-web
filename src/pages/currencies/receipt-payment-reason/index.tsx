...
export default function ReceiptPaymentReasonPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <DataTable columns={columns} data={items} loading={isLoading} total={total} page={page} pageSize={pageSize} onPageSizeChange={setPageSize} onPageChange={setPage} emptyText="Không có lý do thu chi" />
