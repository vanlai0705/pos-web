...
export default function OpeningInventoryPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <DataTable columns={columns} data={items} loading={isLoading} total={total} page={page} pageSize={PAGE_SIZE} onPageChange={setPage} emptyText="Không có dữ liệu tồn kho ban đầu" />
    </div>
  )
}
