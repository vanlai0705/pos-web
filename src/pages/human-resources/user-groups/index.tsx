...
interface TUserGroup { Id?: number; Name?: string; Note?: string; Status?: { Id?: number; Name?: string } }
const EMPTY = (): TUserGroup => ({ Name: '' })
...
export default function UserGroupsPage() {
  ...
  const { mutate: save, isLoading: saving } = useApiMutation(
    (body: TUserGroup) => ({ url: body.Id ? 'usergroup/update' : 'usergroup/create', method: 'POST' as const, body }),
  ...
  return (
    <div className="space-y-4">
      ...
      <DataTable columns={columns} data={items} loading={isLoading} total={total} page={page} pageSize={PAGE_SIZE} onPageChange={setPage} emptyText="Không có nhóm người dùng nào" />
