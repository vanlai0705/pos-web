...
export default function StockTransfersPage() {
  ...
  const changeStatus = async (row: { Id?: number }, statusId: number) => {
    ...
    try {
      await request({ url: `stocktransfers/update-status?id=${row.Id}&statusId=${statusId}`, method: 'POST', body: {} }).unwrap()
  ...
  return (
    <div className="space-y-4">
      ...
      <StockDocumentDialog
        ...
        endpoints={{ detail: 'stocktransfers/detail', create: 'stocktransfers/create', update: 'stocktransfers/update' }}
